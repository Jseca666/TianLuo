...
from xxxxxx import AndroidDevice  # 确保这个模块在你的环境中可用

X_file='Zhuangyuan'
X_json='Zhuangyuan.json'
...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        button_layout.addWidget(self.save_info_btn)
        ...
        self.areas_dir = self.script_dir / 'location' / X_file
    ...
    def process_selected_area(self, rect):
        if self.image is None:
            QMessageBox.warning(self, "警告", "请先捕获截图。")
            return
        ...
        try:
            ...
            # 添加区域信息，使用相对路径
            relative_image_path = image_path.relative_to(self.script_dir)
