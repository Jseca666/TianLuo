...
from .main_export_quality_v08_project_export_facade import MainExportQualityV08ProjectExportFacade


class MainExportQualityV08ProjectExportReportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.facade = MainExportQualityV08ProjectExportFacade(repo_root)
