...
from task_exporters.main_export_quality_runtime_behavior_task_export_session import MainExportQualityRuntimeBehaviorTaskExportSession


class MainExportQualityRuntimeBehaviorProjectExportWorkflow:
    ...
    def export(self, task_specs: Iterable[dict], output_root: Path, project_name: str = "GeneratedAndroidProject") -> MainExportQualityProjectExportResult:
        ...
        export_result = MainExportQualityRuntimeBehaviorTaskExportSession(self.repo_root).run(tasks)
        ...
        return MainExportQualityProjectExportResult(
            ...
            metadata={
                ...
                "quality_line": "runtime_behavior_semantic_tracking",
            },
        )
