...
from task_exporters.main_export_quality_runtime_semantic_task_export_session import MainExportQualityRuntimeSemanticTaskExportSession


class MainExportQualityRuntimeSemanticProjectExportWorkflow:
    ...
    def export(self, task_specs: Iterable[dict], output_root: Path, project_name: str = "GeneratedAndroidProject") -> MainExportQualityProjectExportResult:
        ...
        export_result = MainExportQualityRuntimeSemanticTaskExportSession(self.repo_root).run(tasks)
        ...
        return MainExportQualityProjectExportResult(
            ...
            metadata={
                ...
                "quality_line": "runtime_semantic_ocr_extension",
            },
        )
