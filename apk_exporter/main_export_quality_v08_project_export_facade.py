...
from .main_export_quality_v08_project_export_workflow import MainExportQualityV08ProjectExportWorkflow


class MainExportQualityV08ProjectExportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.workflow = MainExportQualityV08ProjectExportWorkflow(repo_root)
