...
from .main_export_core_actions_project_export_facade import MainExportCoreActionsProjectExportFacade
from .main_export_quality_project_export_writer import MainExportQualityProjectExportWriter


class MainExportCoreActionsProjectExportReportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.facade = MainExportCoreActionsProjectExportFacade(repo_root)
