...
from .main_export_quality_semantic_project_export_workflow import MainExportQualitySemanticProjectExportWorkflow


class MainExportQualitySemanticProjectExportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.workflow = MainExportQualitySemanticProjectExportWorkflow(repo_root)
