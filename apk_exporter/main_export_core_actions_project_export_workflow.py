...
from task_exporters.main_export_core_actions_task_builder import MainExportCoreActionsTaskBuilder
from task_exporters.main_export_core_actions_task_export_session import MainExportCoreActionsTaskExportSession


class MainExportCoreActionsProjectExportWorkflow:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.task_builder = MainExportCoreActionsTaskBuilder()
    ...
    def export(self, task_specs: Iterable[dict], output_root: Path, project_name: str = "GeneratedAndroidProject") -> MainExportQualityProjectExportResult:
        ...
        export_result = MainExportCoreActionsTaskExportSession(self.repo_root).run(tasks)
        ...
        return MainExportQualityProjectExportResult(
            ...
            metadata={
                ...
                "quality_line": "core_actions_direct_export",
            },
        )
