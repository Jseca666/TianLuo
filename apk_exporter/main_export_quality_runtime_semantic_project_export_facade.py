...
from .main_export_quality_runtime_semantic_project_export_workflow import MainExportQualityRuntimeSemanticProjectExportWorkflow


class MainExportQualityRuntimeSemanticProjectExportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.workflow = MainExportQualityRuntimeSemanticProjectExportWorkflow(repo_root)
