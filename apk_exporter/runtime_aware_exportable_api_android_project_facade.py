...
from .runtime_aware_android_studio_project_export_workflow import RuntimeAwareAndroidStudioProjectExportWorkflow
from task_exporters.runtime_exportable_api_task_builder import RuntimeExportableApiTaskBuilder


class RuntimeAwareExportableApiAndroidProjectFacade:
    ...
    def export(self, task_specs: Iterable[dict], output_root: Path, project_name: str = "GeneratedAndroidProject") -> dict:
        ...
        export_result = RuntimeAwareAndroidStudioProjectExportWorkflow(self.repo_root).run(
            tasks=tasks,
