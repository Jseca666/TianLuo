...
from task_exporters.main_export_core_actions_runtime_ready_task_builder import MainExportCoreActionsRuntimeReadyTaskBuilder
from task_exporters.main_export_core_actions_runtime_ready_task_export_session import MainExportCoreActionsRuntimeReadyTaskExportSession


class MainExportCoreActionsRuntimeReadyProjectExportWorkflow:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.task_builder = MainExportCoreActionsRuntimeReadyTaskBuilder()
    ...
    def export(self, task_specs: Iterable[dict], output_root: Path, project_name: str = "GeneratedAndroidProject") -> MainExportQualityProjectExportResult:
        ...
        export_result = MainExportCoreActionsRuntimeReadyTaskExportSession(self.repo_root).run(tasks)
        ...
        return MainExportQualityProjectExportResult(
            ...
            metadata={
                ...
                "quality_line": "core_actions_runtime_ready_export",
            },
        )
