...
from .main_export_quality_semantic_project_export_facade import MainExportQualitySemanticProjectExportFacade


class MainExportQualitySemanticProjectExportReportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.facade = MainExportQualitySemanticProjectExportFacade(repo_root)
