...
from .main_export_quality_project_export_workflow import MainExportQualityProjectExportWorkflow


class MainExportQualityProjectExportFacade:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.workflow = MainExportQualityProjectExportWorkflow(repo_root)
