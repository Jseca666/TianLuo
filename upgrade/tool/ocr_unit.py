...
class Uocr:
    def __init__(self, flag):
        if flag==1:
            ...
            self.lang='ch'
            det_model_dir ='base_tool/ocr_modes/det/ch/ch_PP-OCRv4_det_infer'
            rec_model_dir = 'base_tool/ocr_modes/rec/ch/ch_PP-OCRv4_rec_infer'
            cls_model_dir = 'base_tool/ocr_modes/cls/ch_ppocr_mobile_v2.0_cls_infer'
            ...
            rec_model_dir = 'base_tool/ocr_modes/rec/eh/ch_PP-OCRv4_rec_infer'
            cls_model_dir = 'base_tool/ocr_modes/cls/ch_ppocr_mobile_v2.0_cls_infer'
            self.OCR = PaddleOCR( lang=self.lang, show_log=False,det_model_dir=det_model_dir,rec_model_dir=rec_model_dir,
                                cls_model_dir=cls_model_dir)
        else:
