...
from .improved_compilable_runtime_kotlin_step_renderer import ImprovedCompilableRuntimeKotlinStepRenderer
from .task_export_result import TaskExportResult
from .task_registry_writer import TaskRegistryWriter


class ImprovedCompilableRuntimeTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = ImprovedCompilableRuntimeKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Improved compilable runtime task generated")
    }}
}}
'''
