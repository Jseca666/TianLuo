...
from .main_export_quality_semantic_kotlin_step_renderer import MainExportQualitySemanticKotlinStepRenderer
from .task_export_result import TaskExportResult
from .task_registry_writer import TaskRegistryWriter


class MainExportQualitySemanticTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = MainExportQualitySemanticKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Main export quality semantic runtime task generated")
    }}
}}
'''
