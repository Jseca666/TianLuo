...
from .delivery_ready_compilable_runtime_kotlin_step_renderer import DeliveryReadyCompilableRuntimeKotlinStepRenderer
...
class DeliveryReadyCompilableRuntimeTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = DeliveryReadyCompilableRuntimeKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Delivery-ready runtime task generated")
    }}
}}
'''
