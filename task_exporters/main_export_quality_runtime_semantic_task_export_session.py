...
from .main_export_quality_runtime_semantic_kotlin_step_renderer import MainExportQualityRuntimeSemanticKotlinStepRenderer
from .task_export_result import TaskExportResult
from .task_registry_writer import TaskRegistryWriter


class MainExportQualityRuntimeSemanticTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = MainExportQualityRuntimeSemanticKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Main export quality runtime semantic task generated")
    }}
}}
'''
