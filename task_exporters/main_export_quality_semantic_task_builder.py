...
from .main_export_quality_semantic_step_mapper import MainExportQualitySemanticStepMapper


class MainExportQualitySemanticTaskBuilder:
    def __init__(self):
        self.step_mapper = MainExportQualitySemanticStepMapper()
