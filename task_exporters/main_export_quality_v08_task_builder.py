...
from .main_export_quality_v08_step_mapper import MainExportQualityV08StepMapper


class MainExportQualityV08TaskBuilder:
    def __init__(self):
        self.step_mapper = MainExportQualityV08StepMapper()
