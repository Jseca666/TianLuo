...
from .main_export_core_actions_runtime_ready_kotlin_step_renderer import MainExportCoreActionsRuntimeReadyKotlinStepRenderer
from .task_export_result import TaskExportResult
from .task_registry_writer import TaskRegistryWriter


class MainExportCoreActionsRuntimeReadyTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = MainExportCoreActionsRuntimeReadyKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Main export core actions runtime-ready task generated")
    }}
}}
'''
