...
from .main_export_quality_runtime_behavior_kotlin_step_renderer import MainExportQualityRuntimeBehaviorKotlinStepRenderer
from .task_export_result import TaskExportResult
from .task_registry_writer import TaskRegistryWriter


class MainExportQualityRuntimeBehaviorTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = MainExportQualityRuntimeBehaviorKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Main export quality runtime behavior task generated")
    }}
}}
'''
