...
from .main_export_quality_kotlin_step_renderer import MainExportQualityKotlinStepRenderer
from .task_export_result import TaskExportResult
from .task_registry_writer import TaskRegistryWriter


class MainExportQualityV08TaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = MainExportQualityKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Main export quality v0.8 runtime task generated")
    }}
}}
'''
