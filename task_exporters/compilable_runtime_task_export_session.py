...
from .compilable_runtime_kotlin_step_renderer import CompilableRuntimeKotlinStepRenderer
...
class CompilableRuntimeTaskExportSession:
    def __init__(self, repo_root: Path):
        self.repo_root = Path(repo_root)
        self.step_renderer = CompilableRuntimeKotlinStepRenderer()
...
{steps_block}
        return TaskResult.ok("Compilable runtime task generated")
    }}
}}
'''
